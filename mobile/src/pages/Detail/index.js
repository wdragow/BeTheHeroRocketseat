...
export default function Detail() {
    ...
    const message = 'Olá APAD, estou entrando em contato pois gostaria de ajudar no caso "TAL" com o valor de R$120,00';
    ...
    function sendWhatsapp() {
        Linking.openURL(`whatsapp://send?phone=+554197918259&text=${message}`);
    }
